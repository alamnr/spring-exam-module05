...
import com.spring.professional.exam.tutorial.module05.question10.storage.InMemoryStorage;
...
public class Example07RequestPart {
	...
	{
		return String.format("Received person = [%s] and country = [%s] \n", person,country);
	}
	...
	{
		return String.format("Received person = [%s] and error count = [%d] \n", person, bindingResult.getErrorCount());
	}
